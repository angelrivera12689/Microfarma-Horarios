...
const Shifts = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // No bloquear la creación de turnos si ya existe otro turno para el mismo empleado y fecha.
    // Se permite crear un turno distinto en la misma ubicación cuando corresponda.
    setFormError(null);
    setSubmitting(true);
