 ...
 */
abstract public class ASchedulesBaseService<T extends ASchedulesBaseEntity> implements ISchedulesBaseService<T> {
     ...
     */
    protected abstract ISchedulesBaseRepository<T, String> getRepository();
