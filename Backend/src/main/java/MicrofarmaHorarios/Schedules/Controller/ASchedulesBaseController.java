 ...
 *
 * @param <T> The type of entity extending ASchedulesBaseEntity.
 * @param <S> The type of service implementing ISchedulesBaseService for the entity.
 */
public abstract class ASchedulesBaseController<T extends ASchedulesBaseEntity, S extends ISchedulesBaseService<T>> {
    ...
    /**
     * Constructor for ASchedulesBaseController.
     *
     * @param service    The service for the entity.
     * @param entityName The name of the entity.
     */
    protected ASchedulesBaseController(S service, String entityName) {
