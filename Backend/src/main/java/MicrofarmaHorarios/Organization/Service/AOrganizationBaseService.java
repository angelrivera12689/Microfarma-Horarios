 ...
 */
abstract public class AOrganizationBaseService<T extends AOrganizationBaseEntity> implements IOrganizationBaseService<T> {
     ...
     */
    protected abstract IOrganizationBaseRepository<T, String> getRepository();
