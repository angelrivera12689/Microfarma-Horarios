...
import MicrofarmaHorarios.Organization.IService.IOrganizationBaseService;
 ...
 *
 * @param <T> The type of entity extending AOrganizationBaseEntity.
 * @param <S> The type of service implementing IOrganizationBaseService for the entity.
 */
public abstract class AOrganizationBaseController<T extends AOrganizationBaseEntity, S extends IOrganizationBaseService<T>> {

    protected S service;
    protected String entityName;

    /**
     * Constructor for AOrganizationBaseController.
     *
     * @param service    The service for the entity.
     * @param entityName The name of the entity.
     */
    protected AOrganizationBaseController(S service, String entityName) {
