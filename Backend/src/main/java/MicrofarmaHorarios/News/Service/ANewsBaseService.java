 ...
 */
abstract public class ANewsBaseService<T extends ANewsBaseEntity> implements INewsBaseService<T> {
     ...
     */
    protected abstract INewsBaseRepository<T, String> getRepository();
